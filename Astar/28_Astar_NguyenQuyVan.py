import queue #import thư viện
from mymap import myMap, heuristic #import file mymap
from modules import showResultWithAttr, showStep, aweSomeSort #import file modules

def AStar(start, goal):
  q = queue.deque() # khởi tạo thuật toán
  ...
  while 1:
    ...
    if curCity == goal:   #nếu curCity tới điểm goal
      print('Success!')   #xuất ra hoàn thành
